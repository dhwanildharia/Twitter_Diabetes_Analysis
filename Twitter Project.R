...
write.csv(tweets.df1 , file = "/your path here.csv")
...
insulin_prices_tweets = searchTwitter('#insulin', n=10000, lang="en")
...
wordcloud(insulin_prices_corpus,min.freq = 50,colors=brewer.pal(8, "Dark2"),random.color = TRUE,max.words = 100)
...
hist(jscores$ave_sentiment,breaks = 10)
